...
SECRET_KEY = 'django-insecure-(g77(@!i@mie14a+hwksh+vsnt45)zlk%z)+#6ujzyp)ab0v=x'
...
MIDDLEWARE = [
    ...
    'emotion_app.middleware.AuthenticationMiddleware',
]
...
# MongoDB connection for the application (used in views)
...
# Enable serving static files directly from development server
DEBUG = True
...
# Custom User model
AUTH_USER_MODEL = 'emotion_app.User'
